...
public class Barnesnoble {
   ...
   final Logger lobj = Logger.getLogger(getClass());
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("C:/Users/Dell/Desktop/upload/CC2/CC2/cclogandreport/report.html");
    ...
    {
        PropertyConfigurator.configure("C:/Users/Dell/Desktop/upload/CC2/CC2/cc2/src/main/java/com/example/resources/log4j2.properties");
    ...
    {  
        FileInputStream fs=new FileInputStream("C:/Users/Dell/Desktop/upload/CC2/CC2/ccexcel.xlsx");
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath = "C:/Users/Dell/Desktop/upload/CC2/CC2/cclogandreport"+result.getName()+".png";
