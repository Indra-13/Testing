...
public class AppTest 
{
    ...
    public void bt()
    {
        ExtentSparkReporter sparkReporter=new ExtentSparkReporter("C:/Users/Dell/Desktop/Traning sub/software Testing/AllDays/testing/DAY 9/CE2Report.reportce2.html");
...
element3.sendKeys(tenure); // Enter the new value
    ...
    public void am(ITestResult result) throws IOException
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path="C:\\Users\\Dell\\Desktop\\Traning sub\\software Testing\\AllDays\\testing\\DAY 9"+result.getName()+".png";
...
{
    FileInputStream fs=new FileInputStream("C:/Users/Dell/Desktop/Traning sub/software Testing/AllDays/testing/DAY 9/Book2.xlsx");
